...
SELECT 
    ...
    CLEAN_STRING(SRC.GOVT_ID_CLS_CD) AS PARTY_ID_STATUS_TYPE_CDE,
...
AND SRC.ADD_UPD_DEL_IND = 'I';   -- what happens when a already deleted record(locical_src = false and curren_ind = false) comes again as new record . will it be inserted with begin date as '00000'
